const messageKeyMap = {
    ...
    '统计阶段无效': 'tournament.errors.mappoolStatsStageInvalid',
    '该阶段不存在': 'tournament.errors.mappoolStatsStageNotFound',
    '该阶段图池为空': 'tournament.errors.mappoolStatsMappoolEmpty',
    '该阶段没有比赛': 'tournament.errors.mappoolStatsNoMatches',
    '该阶段仍有未完成比赛': 'tournament.errors.mappoolStatsMatchesIncomplete',
    '图池统计计算完成': 'tournament.messages.mappoolStatsCalculated',
    ...
    '决胜谱面不能被保护或禁用': 'tournament.errors.tiebreakerProtectBanForbidden',
    '决胜谱面由系统自动选择': 'tournament.errors.tiebreakerPickAutomatic',
    '常规选图尚未完成，不能选择决胜谱面': 'tournament.errors.tiebreakerBeforeRegulationComplete',
    '常规选图已完成，只能选择决胜谱面': 'tournament.errors.tiebreakerRequiredAfterRegulation',
    '比赛已结束，不能继续选图': 'tournament.errors.completedMatchCannotPick',
    '自动决胜谱面操作不能手动修改': 'tournament.errors.automaticTiebreakerImmutable',
